...
def main(file : str):
    ...
    if OSName.OS_WINDOWS == os_name:
        cmd = f'pyinstaller -i ./{app_project_name}/app/resource/favicon.ico -n {exe_name} ./{app_project_name}/app/main.py --uac-admin --onefile --noconsole --upx-dir=./upx-4.2.1-win64 --version-file=./{app_project_name}/app/version.txt'
    else:
